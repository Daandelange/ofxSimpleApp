...
It is my personal ofApp class that I use across many projects, I hope it's useful for you too.  
...
- [ofxFFmpegRecorder](https://github.com/Daandelange/ofxFFmpegRecorder) _(Sorry, a fork of a fork)_
- [ofxPugiXML](https://github.com/Daandelange/ofxPugiXML) _(Sorry, a fork of a fork)_
