// Spectrum Theme, adapted to ofxImGui themes
// Stripped version of https://github.com/adobe/imgui/blob/master/imgui_spectrum.h (MIT)
...
class Spectrum : public ofxImGui::BaseTheme {
    ...
    static const constexpr float CHECKBOX_BORDER_SIZE = 2.0f;
    static const constexpr float CHECKBOX_ROUNDING = 2.0f;
    ...
    static unsigned int Color(unsigned int c) {
        // add alpha.
    ...
    static inline unsigned int color_alpha(unsigned int alpha, unsigned int c) {
...
//        const unsigned int PURPLE700 = Color(0x6F38B1);
    ...
    void setup() override {
        ...
        // Set some colors compatible with new theme variables for easier updating
        //ofColor col_main_text = ColorConvertU32ToFloat4(GRAY800);
        ofColor col_main_head = ColorConvertU32ToFloat4(GRAY300);
        ofColor col_main_area = ColorConvertU32ToFloat4(GRAY200);
        //ofColor col_win_popup = ColorConvertU32ToFloat4(GRAY100);
        ofColor col_win_backg = ColorConvertU32ToFloat4(GRAY50);

        style.FrameRounding = 4.0f;
        style.GrabRounding = 4.0f;

        style.Colors[ImGuiCol_Text] = ColorConvertU32ToFloat4(GRAY800); // text on hovered controls is gray900
        style.Colors[ImGuiCol_TextDisabled] = ColorConvertU32ToFloat4(GRAY500);
        style.Colors[ImGuiCol_WindowBg] = ColorConvertU32ToFloat4(GRAY100);
        style.Colors[ImGuiCol_ChildBg] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
        style.Colors[ImGuiCol_PopupBg] = ColorConvertU32ToFloat4(GRAY50); // not sure about this. Note: applies to tooltips too.
        style.Colors[ImGuiCol_Border] = ColorConvertU32ToFloat4(GRAY300);
        style.Colors[ImGuiCol_BorderShadow] = ColorConvertU32ToFloat4(NONE); // We don't want shadows. Ever.
        style.Colors[ImGuiCol_FrameBg] = ColorConvertU32ToFloat4(GRAY200);//GRAY75); // this isnt right, spectrum does not do this, but it's a good fallback
        style.Colors[ImGuiCol_FrameBgHovered] = ColorConvertU32ToFloat4(GRAY300);
        style.Colors[ImGuiCol_FrameBgActive] = ColorConvertU32ToFloat4(GRAY400);
        style.Colors[ImGuiCol_TitleBg] = ColorConvertU32ToFloat4(GRAY300); // those titlebar values are totally made up, spectrum does not have this.
        style.Colors[ImGuiCol_TitleBgActive] = ColorConvertU32ToFloat4(GRAY200);
        style.Colors[ImGuiCol_TitleBgCollapsed] = ColorConvertU32ToFloat4(GRAY400);
        style.Colors[ImGuiCol_MenuBarBg] = ColorConvertU32ToFloat4(GRAY100);
        style.Colors[ImGuiCol_ScrollbarBg] = ColorConvertU32ToFloat4(GRAY100); // same as regular background
        style.Colors[ImGuiCol_ScrollbarGrab] = ColorConvertU32ToFloat4(GRAY400);
        style.Colors[ImGuiCol_ScrollbarGrabHovered] = ColorConvertU32ToFloat4(GRAY600);
        style.Colors[ImGuiCol_ScrollbarGrabActive] = ColorConvertU32ToFloat4(GRAY700);
        style.Colors[ImGuiCol_CheckMark] = ColorConvertU32ToFloat4(BLUE500);
        style.Colors[ImGuiCol_SliderGrab] = ColorConvertU32ToFloat4(GRAY700);
        style.Colors[ImGuiCol_SliderGrabActive] = ColorConvertU32ToFloat4(GRAY800);
        style.Colors[ImGuiCol_Button] = ColorConvertU32ToFloat4(GRAY75); // match default button to Spectrum's 'Action Button'.
        style.Colors[ImGuiCol_ButtonHovered] = ColorConvertU32ToFloat4(GRAY200);
        style.Colors[ImGuiCol_ButtonActive] = ColorConvertU32ToFloat4(GRAY300);
        style.Colors[ImGuiCol_Header] = ColorConvertU32ToFloat4(BLUE400);
        style.Colors[ImGuiCol_HeaderHovered] = ColorConvertU32ToFloat4(BLUE500);
        style.Colors[ImGuiCol_HeaderActive] = ColorConvertU32ToFloat4(BLUE600);
        style.Colors[ImGuiCol_Separator] = ColorConvertU32ToFloat4(GRAY400);
        style.Colors[ImGuiCol_SeparatorHovered] = ColorConvertU32ToFloat4(GRAY600);
        style.Colors[ImGuiCol_SeparatorActive] = ColorConvertU32ToFloat4(GRAY700);
        style.Colors[ImGuiCol_ResizeGrip] = ColorConvertU32ToFloat4(GRAY400);
        style.Colors[ImGuiCol_ResizeGripHovered] = ColorConvertU32ToFloat4(GRAY600);
        style.Colors[ImGuiCol_ResizeGripActive] = ColorConvertU32ToFloat4(GRAY700);
        style.Colors[ImGuiCol_PlotLines] = ColorConvertU32ToFloat4(BLUE400);
        style.Colors[ImGuiCol_PlotLinesHovered] = ColorConvertU32ToFloat4(BLUE600);
        style.Colors[ImGuiCol_PlotHistogram] = ColorConvertU32ToFloat4(BLUE400);
        ...
        // New ones added, not present in the original
