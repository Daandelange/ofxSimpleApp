...
# Add your defines below, this example uses them all
################################################################################

# This is an alternative method to all the stuff below and you need to symlink your `ofxSAUserConfig`
# to `addons/ofxSimpleApp/src/configs/` so that the addon can access your project settings. 
PROJECT_DEFINES = ofxSA_CONFIG_HEADER_FILE=ofxSAUserConfig
# PROJECT_DEFINES = ofxSA_CONFIG_HEADER_FILE="ofxSAUserConfig.h"
...
# # Below: No spaces, no special characters, serves as an ID.
# PROJECT_DEFINES += ofxSA_APP_ID="ofxSimpleAppExampleAdvanced"
...
# PROJECT_DEFINES += ofxSA_QUADWRAPPER_ENABLE
